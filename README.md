...
**wallpaper** by [Adrien Olichon](https://unsplash.com/@adrienolichon) via unsplash.com [wallpaper.png](screenshot/AdrienOlichon.png)

**wallpaper 2** [by Anchor Lee](https://unsplash.com/@anchorlee) via unsplash.com [wallpaper.png](screenshot/AnchorLee.png)

**palette** by [DarkBlueMe4Ever](https://www.colourlovers.com/palette/2801382/Chlorinated_Dolphin) via colorlovers.com [wal file](screenshot/ChlorinatedDolphin.json)

**palette 2** by [GabsGiggles](https://www.colourlovers.com/palette/1811244/1001_Stories) via colorlovers.com [wal file](screenshot/1001Stories-light.json)
